...
class HidGamepadService : Service() {
    ...
    companion object {
        ...
        // intArrayOf keeps the descriptor readable while avoiding Kotlin Byte literal errors.
        val REPORT_DESCRIPTOR = intArrayOf(
            0x05, 0x01, 0x09, 0x05, 0xA1, 0x01,
            0x85, REPORT_ID, 0x09, 0x30, 0x09, 0x31,
            0x16, 0x00, 0x80, 0x26, 0xFF, 0x7F, 0x75, 0x10, 0x95, 0x02, 0x81, 0x02,

...
# DeepCore — first playable foundation
...
var ore_nodes := [
    {"name":"Carvão", "value":2.0, "min_depth":0, "weight":65},
    {"name":"Cobre", "value":5.0, "min_depth":25, "weight":25},
    {"name":"Ferro", "value":10.0, "min_depth":60, "weight":10}
]
...
func _draw() -> void:
    ...
    draw_circle(Vector2(438,410), 58, Color("#0a151b"))
    draw_circle(Vector2(438,410), 46, Color("#15232a"))

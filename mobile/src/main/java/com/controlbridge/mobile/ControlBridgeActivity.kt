...
class ControlBridgeActivity : Activity() {
    ...
    override fun dispatchKeyEvent(event: KeyEvent): Boolean {
        ...
        hud.invalidate()
        bridge.broadcast(JSONObject().apply {
            put("type", "key")
    ...
    private inner class Hud : View(this@ControlBridgeActivity) {
        ...
        override fun onDraw(canvas: Canvas) {
            ...
            canvas.drawText(if (connected) "MANETE DETECTADA" else "CONECTE A MANETE PELO BLUETOOTH DO ANDROID", 34f, 192f, paint)
        ...
        private fun drawPad(canvas: Canvas, w: Float, h: Float) {
            ...
            drawButton(canvas, a, "A")
            drawButton(canvas, b, "B")
            drawButton(canvas, x, "X")
            drawButton(canvas, y, "Y")
        }
